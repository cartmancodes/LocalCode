// "core" entries are not backend rows — they open a session on the core
// RPC protocol at /api/core/rpc, where the loop runs in the vendor binary.
export type Provider = "claude" | "opencode" | "fleet" | "core";
